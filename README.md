...
```bash
wget https://github.com/textmagic/textmagic-rest-perl-v2/archive/v2.0.865.tar.gz && \
tar zxf v2.0.865.tar.gz && \
rm -f v2.0.865.tar.gz && \
cd textmagic-rest-perl-v2-2.0.865 && \
perl Makefile.pl && \
make && \
make install && \
cpanm --installdeps .
