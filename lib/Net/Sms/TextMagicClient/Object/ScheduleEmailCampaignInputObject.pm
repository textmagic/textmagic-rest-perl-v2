...
#
package Net::Sms::TextMagicClient::Object::ScheduleEmailCampaignInputObject;
...
__PACKAGE__->method_documentation({
    ...
    'recipients' => {
    	datatype => 'Apiv2emailcampaignsscheduleRecipients',
    ...
    'schedule_params' => {
    	datatype => 'Apiv2emailcampaignsscheduleScheduleParams',
