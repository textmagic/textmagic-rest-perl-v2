...
#
package Net::Sms::TextMagicClient::Object::Apiv2emailcampaignsscheduleScheduleParams;
...
__PACKAGE__->class_documentation({description => 'Scheduling configuration for the campaign.',
                                  class => 'Apiv2emailcampaignsscheduleScheduleParams',
                                  required => [], # TODO
}                                 );
