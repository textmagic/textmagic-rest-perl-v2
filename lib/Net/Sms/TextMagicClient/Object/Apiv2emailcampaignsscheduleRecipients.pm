...
#
package Net::Sms::TextMagicClient::Object::Apiv2emailcampaignsscheduleRecipients;
...
__PACKAGE__->class_documentation({description => 'Campaign recipients configuration.',
                                  class => 'Apiv2emailcampaignsscheduleRecipients',
                                  required => [], # TODO
}                                 );
