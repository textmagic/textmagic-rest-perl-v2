# Net::Sms::TextMagicClient::Object::UpdateChatDesktopNotificationSettingsRequest

## Load the model package
```perl
use Net::Sms::TextMagicClient::Object::UpdateChatDesktopNotificationSettingsRequest;
```
