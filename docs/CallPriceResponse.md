# Net::Sms::TextMagicClient::Object::CallPriceResponse
...
------------ | ------------- | ------------- | -------------
**outbound** | **double** | Price for outbound message. | 
**inbound** | **double** | Price for inbound message. | 
**forward** | **double** | Price for forward. | 
