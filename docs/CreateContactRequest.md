# Net::Sms::TextMagicClient::Object::CreateContactRequest

## Load the model package
```perl
use Net::Sms::TextMagicClient::Object::CreateContactRequest;
```
...
**tags** | **ARRAY[int]** | An array of tag IDs that will be assigned to the contact. | [optional] 
