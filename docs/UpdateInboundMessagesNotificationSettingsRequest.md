# Net::Sms::TextMagicClient::Object::UpdateInboundMessagesNotificationSettingsRequest

## Load the model package
```perl
use Net::Sms::TextMagicClient::Object::UpdateInboundMessagesNotificationSettingsRequest;
```
